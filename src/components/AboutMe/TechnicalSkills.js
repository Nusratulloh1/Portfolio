...
export const mySkills = [
    {
        ...
        tools: [
            ...
            {
                icon: `<img width="50px" src="https://cdn.quasar.dev/logo-v2/svg/logo.svg" />`,
                text: 'Quasar',
                des: `............................`,
            },
            {
                icon: `<img width="50px" src="https://cdn.vuetifyjs.com/docs/images/logos/vuetify-logo-light.svg" />`,
                text: 'Vuetify',
                des: `Vuetify is a Vue UI Library with beautifully handcrafted Material Components. No design skills required — everything you need to create amazing applications is at your fingertips.`,
            },
            {
                icon: `<img src="https://nafie.webrouk.com/html/assets/images/skills/typescript.png" />`,
                text: 'TypeScript',
                des: `TypeScript is a strongly typed programming language which builds on JavaScript giving you better tooling at any scale <a href="https://www.typescriptlang.org/" target="_blank" alt="go to Nuxtjs">Go To TS</a>`,
            },
            {
                icon: `<img src="https://nafie.webrouk.com/html/assets/images/skills/jquery.png" />`,
                text: 'jQuery',
                des: `jQuery is a fast, small, and feature-rich JavaScript library. It makes things like HTML document traversal and manipulation, event handling, animation, and Ajax much simpler with an easy-to-use API that works across a multitude of browsers. With a combination of versatility and extensibility, jQuery has changed the way that millions of people write JavaScript. <a href="https://jquery.com/" target="_blank" alt="go to Nuxtjs">Go To jQuery</a>`,
            },
        ]
    },
    {
        ...
        tools: [
            ...
            },
            {
                ...
                svg: true,
                text: "Materializecss",
                des: `If you are already familiar with Tailwind CSS, think about Materialize CSS as an on-demand alternative to Tailwind, which provides faster load times, fully compatible with Tailwind v2.0 and with a bunch of additional cool features.`
            },
            {
    ...
    },
    {
        ...
        tech: "UI Design",
        des: "As a developer that also works with frontend development. I started to learn and gain experience for UX designing because everything I built, I want it to be User Friendly.",
        yearStarted: 2021,
        tools: [
            {
            ...
            {
                icon: `<img src="https://nafie.webrouk.com/html/assets/images/skills/photoshop.png" />`,
                text: `Photoshop`,
                des: `As a developer that also works with frontend development, I started to learn and gain experience in UX designing because I want it to be User Friendly. Figma is great for creating designs and is what I use.`
            }
        ]
